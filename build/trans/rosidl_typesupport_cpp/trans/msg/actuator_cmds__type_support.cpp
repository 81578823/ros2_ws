...
static const _ActuatorCmds_type_support_symbol_names_t _ActuatorCmds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trans, msg, ActuatorCmds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, trans, msg, ActuatorCmds)),
  }
};
...
{
  return &::trans::msg::rosidl_typesupport_cpp::ActuatorCmds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, trans, msg, ActuatorCmds)() {
  return get_message_type_support_handle<trans::msg::ActuatorCmds>();
}
