...
#include "trans/srv/detail/gait_switch__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trans::srv::GaitSwitch_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trans::srv::GaitSwitch_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trans::srv::GaitSwitch_Request *>(
    untyped_ros_message);
...
{
  return &trans::srv::typesupport_fastrtps_cpp::_GaitSwitch_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = trans::srv::GaitSwitch_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trans::srv::GaitSwitch_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<trans::srv::GaitSwitch_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &trans::srv::typesupport_fastrtps_cpp::_GaitSwitch_Response__handle;
}
...
{
  return &trans::srv::typesupport_fastrtps_cpp::_GaitSwitch__handle;
}
