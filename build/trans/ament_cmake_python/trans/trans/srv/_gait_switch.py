...
class Metaclass_GaitSwitch(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from trans.srv import _gait_switch
...
class GaitSwitch(metaclass=Metaclass_GaitSwitch):
    from trans.srv._gait_switch import GaitSwitch_Request as Request
    from trans.srv._gait_switch import GaitSwitch_Response as Response
