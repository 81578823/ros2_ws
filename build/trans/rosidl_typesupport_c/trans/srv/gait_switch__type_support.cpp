...
static const _GaitSwitch_Request_type_support_symbol_names_t _GaitSwitch_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trans, srv, GaitSwitch_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trans, srv, GaitSwitch_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, trans, srv, GaitSwitch_Request)() {
  return &::trans::srv::rosidl_typesupport_c::GaitSwitch_Request_message_type_support_handle;
}
...
static const _GaitSwitch_Response_type_support_symbol_names_t _GaitSwitch_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trans, srv, GaitSwitch_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trans, srv, GaitSwitch_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, trans, srv, GaitSwitch_Response)() {
  return &::trans::srv::rosidl_typesupport_c::GaitSwitch_Response_message_type_support_handle;
}
...
static const _GaitSwitch_type_support_symbol_names_t _GaitSwitch_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trans, srv, GaitSwitch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trans, srv, GaitSwitch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, trans, srv, GaitSwitch)() {
  return &::trans::srv::rosidl_typesupport_c::GaitSwitch_service_type_support_handle;
}
