...
static const _ActuatorCmds_type_support_symbol_names_t _ActuatorCmds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trans, msg, ActuatorCmds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trans, msg, ActuatorCmds)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, trans, msg, ActuatorCmds)() {
  return &::trans::msg::rosidl_typesupport_c::ActuatorCmds_message_type_support_handle;
}
