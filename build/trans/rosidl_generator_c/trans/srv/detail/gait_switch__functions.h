...
#ifndef TRANS__SRV__DETAIL__GAIT_SWITCH__FUNCTIONS_H_
#define TRANS__SRV__DETAIL__GAIT_SWITCH__FUNCTIONS_H_
 ...
 * calls
 * trans__srv__GaitSwitch_Request__init().
...
/**
 * It calls
 * trans__srv__GaitSwitch_Request__fini()
 ...
 * trans__srv__GaitSwitch_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * trans__srv__GaitSwitch_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trans__srv__GaitSwitch_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trans
...
/**
 * It calls
 * trans__srv__GaitSwitch_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_trans
...
/**
 * It allocates the memory for the array and calls
 * trans__srv__GaitSwitch_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trans
...
/**
 * It calls
 * trans__srv__GaitSwitch_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRANS__SRV__DETAIL__GAIT_SWITCH__FUNCTIONS_H_
