...
bool trans__srv__simulation_reset__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("trans.srv._simulation_reset.SimulationReset_Request", full_classname_dest, 51) == 0);
  }
  trans__srv__SimulationReset_Request * ros_message = _ros_message;
  {  // header
...
PyObject * trans__srv__simulation_reset__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("trans.srv._simulation_reset");
...
ROSIDL_GENERATOR_C_EXPORT
bool trans__srv__simulation_reset__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("trans.srv._simulation_reset.SimulationReset_Response", full_classname_dest, 52) == 0);
  }
  trans__srv__SimulationReset_Response * ros_message = _ros_message;
  {  // is_success
