...
class Metaclass_SimulationReset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from trans.srv import _simulation_reset
...
class SimulationReset(metaclass=Metaclass_SimulationReset):
    from trans.srv._simulation_reset import SimulationReset_Request as Request
    from trans.srv._simulation_reset import SimulationReset_Response as Response
